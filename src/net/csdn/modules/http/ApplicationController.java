...
public abstract class ApplicationController {
    ...
    private Class inner_const_get(String type, String name) {
        Settings settings = ServiceFramework.injector.getInstance(Settings.class);
    ...
    public void render(Result result) {
        String content = result.toJson(config);
        restResponse.originContent(content);
        restResponse.write(content, ViewType.json);
    }

    public void render(String template, Map<String, Object> objectMap) {
        restResponse.render(template, objectMap);
    }

    public void redirect(String url) {
        restResponse.redirect(url);
    }
    ...
    public static Map map(Map map, Object... arrays) {
